    ...
    <div className="container profile-page">
      ...
      {tab === "Profile" && (
        <form onSubmit={handleProfileSave} className="profile-form-card">
          ...
          <div className="form-group">
            <label>Profile Picture — click 📷 on avatar to upload from device</label>
            <input placeholder="or paste image URL here..." value={form.profilePicture} onChange={e => { setForm({ ...form, profilePicture: e.target.value }); setAvatarPreview(e.target.value); }} />
          </div>
